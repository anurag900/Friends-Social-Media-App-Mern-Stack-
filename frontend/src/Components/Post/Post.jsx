    ...
    <div className="post">
      ...
      <div className="postDetails">
        ...
        <Link to={`/user/${ownerId}`}>
          <Typography color ={'white'} fontWeight={700}>{ownerName}</Typography>
        </Link>
      ...
      >
        <Typography sx={{color:'white'}}>{likes.length} Likes</Typography>
      </button>
      ...
      >
        <div className="DialogBox" style={{color:"white"}}>
